...
- [X] ~~*Created personal issue linked to Project Tilt using browser.*~~ [2022-02-11]
- [X] ~~*Cloned this repo using VS Code or the command line.*~~ [2022-02-11]
- [X] ~~*Opened the cloned repo with VS Code.*~~ [2022-02-11]
- [X] ~~*Ensured cloned repo `main` branch is up-to-date.*~~ [2022-02-11]
- [X] ~~*Created new branch of the form `<firstname>-<lastname>-training-record`, e.g. `bob-bobson-training-record`*~~ [2022-02-11]
